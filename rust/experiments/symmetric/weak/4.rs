...
// min_length = 0.04 * 0.67^2 = 0.017956 — two levels deeper, ~4x branches
const MIN_LENGTH: f64 = 0.017956;

// Weak scaling: 4 threads, min_length=0.017956 (~4.2M branches, 4x work vs n=1)
fn main() {
