...
// min_length = 0.5 * sqrt(0.67 * 0.57)^2 = 0.191 — two levels deeper, ~4x branches
const MIN_LENGTH: f64 = 0.191;

// Asymmetric weak scaling: 4 threads, min_length=0.191 (~4x work vs n=1)
fn main() {
