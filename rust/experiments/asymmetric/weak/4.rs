...
// min_length = 0.01 * 0.618^2 = 0.003819 — two levels deeper, ~4x branches
const MIN_LENGTH: f64 = 0.003819;

// Asymmetric weak scaling: 4 threads, min_length=0.003819 (~4M branches, 4x work vs n=1)
fn main() {
