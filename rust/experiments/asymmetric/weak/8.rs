...
// min_length = 0.5 * sqrt(0.67 * 0.57)^3 = 0.118 — three levels deeper, ~8x branches
const MIN_LENGTH: f64 = 0.118;

// Asymmetric weak scaling: 8 threads, min_length=0.118 (~8x work vs n=1)
fn main() {
