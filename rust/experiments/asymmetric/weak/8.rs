...
// min_length = 0.01 * 0.618^3 = 0.002360 — three levels deeper, ~8x branches
const MIN_LENGTH: f64 = 0.002360;

// Asymmetric weak scaling: 8 threads, min_length=0.002360 (~8M branches, 8x work vs n=1)
fn main() {
